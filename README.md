...
## Routing failures to a repair operator from features alone
...
Two walkthroughs that compute all of this end to end from two checkpoints, on a 0.6B pair small enough
for one GPU, are in [`docs/archive-toy-examples.md`](docs/archive-toy-examples.md) and are still
